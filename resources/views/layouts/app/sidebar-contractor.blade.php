        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Team Tasks')" class="grid">
                        ...
                        <flux:sidebar.item icon="user" :href="route('user-show')" :current="request()->routeIs('user-home')" wire:navigate>
                            {{ __('view Users') }}
                        </flux:sidebar.item>
                        <flux:sidebar.item icon="wrench-screwdriver" :href="route('showe-skills')" :current="request()->routeIs('skill-home')" wire:navigate>
                            {{ __('Show Skills and Services') }}
                        </flux:sidebar.item>
