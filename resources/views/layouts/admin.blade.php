    ...
    <div class="min-h-screen p-10 bg-white dark:bg-zinc-800">
...
@if(Auth()->user()->isAdmin())
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Score')" class="grid">
...
@else
            <flux:sidebar.nav>
                ...
                <flux:sidebar.item icon="book-open-text" href="https:scoreachor.com" target="_blank">
                    {{ __('Documentation') }}
                </flux:sidebar.item>
            </flux:sidebar.nav>
